...
import DeletUser from '../Component/DeletUser.jsx'
...
export default function UserTable() {
    ...
    const handleUserDelet = async () => {
        try {
            const DeletUser = await axios.delete(`http://localhost:8080/api/delete/${userId}`)
    ...
    const handleOnSubmit = async (e) => {
        ...
        try {
            const UpdatedUser = await axios.put(`http://localhost:8080/api/update/${updatedUserId}`,value)
